...
Se usan dos funciones aparte para crear la ultima función que entrega lo pedido.
...
Se puede apreciar que usando el metodo polar el histograma se asemeja más a la funcion f ocupando una muestra más pequeña, en otras palabras, el metodo polar es mas estable que la transformacion box-muller. Esto se debe a que en el metodo polar no es necesario calcular funciones trigonometricas, por lo tanto es menos costoso computacionalmente.
...
Se puede ver que las aproximaciones son más exactas con las funciones de R que con las funciones creadas
